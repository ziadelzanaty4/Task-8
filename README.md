...
```
## 2- add toolchain to system path in env variables
...
### 2-edit system path 
search for variable named path in system varaibles and click edit
...
![Alt Text](/assets/select_bin_directory_path.PNG)
